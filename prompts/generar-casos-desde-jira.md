...
| :------------------------- | :------------------- | :---------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **NOMENCLATURA_TEST_CASE** | [Nombre Descriptivo] | Positivo/Negativo | **Precondición:** [Estado inicial]<br>**Pasos:**<br>1. Navegar a [Ruta]<br>2. [Acción con selector semántico]<br>**Validación:**<br>Esperar que [Elemento] tenga texto [Valor] |

**Crear archivo con la salida:** en la carpeta .{{**TEST_CASES_FOLDER**}} crea el archivo 
